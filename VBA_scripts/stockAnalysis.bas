...
'Setting up variables for our analysis
   ...
   totalVolume = 0
    ...
    ' Output the analysis results to their coresponding row
    sh.Cells(2, 16).Value = greatestPercentIncreaseTicker
    sh.Cells(2, 17).Value = greatestPercentIncrease & "%"
    sh.Cells(3, 16).Value = greatestPercentDecreaseTicker
    sh.Cells(3, 17).Value = greatestPercentDecrease & "%"
    sh.Cells(4, 16).Value = greatestTotalVolumeTicker
    sh.Cells(4, 17).Value = greatestTotalVolume
